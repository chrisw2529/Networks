canvasWebpackJsonp([91],{"+JpRIS14Qm":function(e,t,i){var n,a
...
var d={TeX:{extensions:["color.js"]}}
function r(){return!("undefined"==typeof MathJax)}},"2aUY+gHXYk":function(e,t,i){"use strict"
var n,a=i("mOY9BNujNR"),o=(n=a)&&n.__esModule?n:{default:n};(0,o.default)(document).on("keydown",".ic-Super-toggle__input",function(e){13===e.which&&(0,o.default)(e.target).click()})},"9vdLYFzxED":function(e,t,i){var n,a
...
Object.defineProperty(t,"__esModule",{value:!0})
var n=r(i("uceVF1dIMW")),a=r(i("mOY9BNujNR")),o=r(i("ArN3I+GqU9")),d=r(i("eJBzaBDd6c"))
i("D2yEjZ1CP5")
function r(e){return e&&e.__esModule?e:{default:e}}var s={buildMinimizerLink:function(){return(0,a.default)('<a href="#" style="font-size: 0.8em;">\n      '+(0,d.default)(n.default.t("links.minimize_embedded_kaltura_content","Minimize embedded content"))+"\n    </a>")},buildCommentHolder:function(e){return(0,a.default)('<div><div class="innerholder" tabindex="-1" style="margin-bottom: 15px;"></div></div>')},getMediaCommentId:function(e){var t=void 0,i=e.data("media_comment_id")||e.find(".media_comment_id:first").text()
i||(t=e.attr("id"))
...
var t
e.remove()
a.default.trackEvent("hide_embedded_content","hide_media")}},u=function(e){(0,a.default)(e.target).find("div.mejs-audio").focus()},l=function(e){return e.closest("td").length>0},c=function(e){return e.closest("td").css("width").replace("px","")<300},_=function(e){return l(e)&&c(e)},m=function(e){var t=e.closest("td"),i=t.css("width")
t.data("orig-width",i)
t.css("width","300px")};(0,a.default)(document).on("click","a.instructure_inline_media_comment",(0,o.default)(function(){if(INST.kalturaSettings){var e=(0,a.default)(this),t="video",i=s.getMediaCommentId(e),d=s.buildCommentHolder(e)
_(e)&&m(e)
e.after(d)
e.hide();("audio"===e.data("media_comment_type")||e.is(".audio_playback, .audio_comment, .instructure_audio_link"))&&(t="audio")
d.children("div").mediaComment("show_inline",i,t,e.data("download")||e.attr("href"))
s.buildMinimizerLink().appendTo(d).click((0,o.default)(function(){var t=e.closest("td")
e.show().focus()
t.css("width",t.data("orig-width"))
s.collapseComment(d)}))
a.default.trackEvent("show_embedded_content","show_media")
d.find(".innerholder").css("outline","none")
d.find(".innerholder").on("focus",u)}else alert(n.default.t("alerts.kaltura_disabled","Kaltura has been disabled for this Canvas site"))}))
t.default=s
e.exports=t.default},D2yEjZ1CP5:function(e,t,i){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
var n=c(i("uceVF1dIMW")),a=c(i("iBw8ZGM6v8")),o=c(i("yvh8ynczHv")),d=c(i("tnyJgcGuAs")),r=c(i("NDO/g0y6Bx")),s=c(i("mOY9BNujNR")),u=c(i("GWHvo/bcLv")),l=c(i("eJBzaBDd6c"))
...
s.default.extend(d.default.MediaElementDefaults,{pluginPath:"/images/mediaelement/",defaultVideoWidth:550,defaultVideoHeight:448})
d.default.MepDefaults.success=function(e,t){(0,u.default)(this.mediaCommentId,e,INST.kalturaSettings)
return e.play()}
d.default.MepDefaults.features.push("googleanalytics")
var m=d.default.MepDefaults.features.indexOf("tracks")+1
d.default.MepDefaults.features.splice(m,0,"sourcechooser")
d.default.MepDefaults.features.splice(m,0,"speed")
function f(e){var t=new s.default.Deferred
s.default.getJSON("/media_objects/"+e+"/info",function(e){var i=e.media_sources.filter(function(e){return"audio/mp3"!==e.content_type}).map(function(e){return"<source\n        type='"+(0,l.default)(e.content_type)+"'\n        src='"+(0,l.default)(e.url)+"'\n        title='"+(0,l.default)(e.width)+"x"+(0,l.default)(e.height)+" "+(0,l.default)(Math.floor(e.bitrate/1024))+" kbps'\n      />"}),n=a.default.map(e.media_tracks,function(e){var t=d.default.language.codes[e.locale]||e.locale
...
return t}function h(e){var t,i,n=e.sourcesAndTracks,a=e.mediaType,o=e.height,r=e.width,u=e.mediaPlayerOptions,l="video"===a?"video":"audio",c=n.sources.concat(n.tracks).join("")
if("audio"===a&&n.types[0].match(/^video\//)&&(t=s.default.extend({mode:"auto"},d.default.MediaElementDefaults,d.default.MepDefaults,u),i=_.getElement("audio",c),"native"!==d.default.HtmlMediaElementShim.determinePlayback(i[0],t,d.default.MediaFeatures.supportsMediaTag,!0,null).method)){l="video"
u.mode="auto_plugin"
u.isVideo=!1
u.videoHeight=o=30}return _.getElement(l,c,r,o)}var g={create:function(e,t,i,n){(0,s.default)("#media_recorder_container").removeAttr("id")
...
e.play()},keyActions:[{keys:a.default.values(r.default.keyCodes),action:function(e,t,i,n){if(e.isVideo){e.showControls()
e.startControlsTimer()}new r.default(d.default,e,t,n).dispatch()}}]},c=h({sourcesAndTracks:u,mediaPlayerOptions:l,mediaType:t,height:s,width:o})
c.appendTo(i.html(""))
...
return u(e.attachment.media_entry_id,o)}return c()},c)}return u(e,o)},show:function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"video",i=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null;(0,s.default)(".play_media_comment").find(".ui-dialog-titlebar-close").click()
var a=(0,s.default)(this),o=a.data("media_comment_dialog")
if(!o){var d=void 0,r=void 0
if("video"===t){d=426
r=550}else{d=180
r=400}var u=(0,s.default)('<div style="overflow: hidden; padding: 0;" />')
"audio"===t&&u.css("padding-top","120px")
u.dialog({dialogClass:"play_media_comment",title:n.default.t("titles.play_comment","Play Media Comment"),width:r,height:d+60,modal:!1,resizable:!1,close:function(){var e=a.data("mediaelementplayer")
e&&e.pause()
i&&i.focus()},open:function(e){(0,s.default)(e.currentTarget).closest(".ui-dialog").attr("role","dialog").attr("aria-label",n.default.t("Play Media Comment"));(0,s.default)(e.currentTarget).parent().find(".ui-dialog-titlebar-close").focus()}})
return u.disableWhileLoading(f(e).done(function(i){if(i.sources.length){var o={can_add_captions:i.can_add_captions,mediaCommentId:e,googleAnalyticsTitle:e},s=h({sourcesAndTracks:i,mediaPlayerOptions:o,mediaType:t,height:d,width:r})
s.appendTo(u.html(""))
a.data({mediaelementplayer:new MediaElementPlayer(s,o),media_comment_dialog:u})}else u.text(n.default.t("media_still_converting","Media is currently being converted, please try again in a little bit."))}))}o.dialog("open")}}
...
Object.defineProperty(t,"__esModule",{value:!0})
var n=d(i("ZrlrdyRlgX")),a=d(i("wxAWXU5KIn")),o=d(i("mOY9BNujNR"))
function d(e){return e&&e.__esModule?e:{default:e}}var r=".lti-thumbnail-launch"
function s(e){e.preventDefault()
u.launch((0,o.default)(e.target).closest(r))}var u=new(function(){function e(){(0,n.default)(this,e);(0,o.default)(document.body).delegate(r,"click",s)}(0,a.default)(e,[{key:"launch",value:function(e){var t=JSON.parse(e.attr("target")),i=(0,o.default)("<iframe/>",{src:e.attr("href"),allowfullscreen:"",width:t.displayWidth||500,height:t.displayHeight||500})
e.replaceWith(i)}}])
return e}())(r)
t.default=u
...
var n,a=i("mOY9BNujNR"),o=(n=a)&&n.__esModule?n:{default:n}
i("t0oyyDFjk2")
function d(e,t,i){var n=void 0
null==t&&(t=e.is(":ui-dialog:hidden")||"true"!==e.attr("aria-expanded"))
var a,r=(0,o.default)("[aria-controls*="+e.attr("id")+"]")
r.filter(function(){return(0,o.default)(this).data("hideWhileTargetShown")}).toggle(!t)
...
if(e.is(":ui-dialog")||(n=e.data("turnIntoDialog"))){if(n&&t){n=o.default.extend({autoOpen:!1,close:function(){d(e,!1)}},n)
e.dialog(n).fixDialogButtons()}if(t){e.dialog("open")
e.data("read-on-open")&&e.dialog("widget").attr("aria-live","assertive").attr("aria-atomic","true")}else e.dialog("isOpen")&&e.dialog("close")}r.each((a=t?"Shown":"Hidden",function(){var e,t=(0,o.default)(this)
if(e=t.data("htmlWhileTarget"+a)){var i="htmlWhileTarget"+("Hidden"===a?"Shown":"Hidden")
t.data(i)||t.data(i,t.html())
t.html(e)}}))}var r={bind:function(){(0,o.default)(document).on("click change keyclick",".element_toggler[aria-controls]",function(e){var t=void 0,i=(0,o.default)(this)
...
a.length&&d(a,t,i)
var r=i.find('i[class*="icon-mini-arrow"].auto_rotate')
...
0===(0,o.default)("#floating_reminders .reminder").length&&(0,o.default)("#floating_reminders").fadeOut("fast",function(){(0,o.default)(this).remove();(0,o.default)("#reminders_icon").remove()})})}})})})},"GWHvo/bcLv":function(e,t,i){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
var n=r(i("ZrlrdyRlgX")),a=r(i("wxAWXU5KIn"))
t.default=function(e,t,i){if(i&&i.do_analytics){var n=new s(e,t,i)
n.addListeners()
return n}}
var o=r(i("mOY9BNujNR")),d=r(i("iBw8ZGM6v8"))
i("YUas7KQMx2")
function r(e){return e&&e.__esModule?e:{default:e}}var s=function(){function e(t,i,a){(0,n.default)(this,e)
...
this.mediaId=t
this.mediaElement=i
this.pluginSettings=a
this.ensureAnalyticSession()
this.generateApiUrl()
this.defaultData={service:"stats",action:"collect","event:entryId":this.mediaId,"event:sessionId":this.kaSession,"event:isFirstInSession":"false","event:objectType":"KalturaStatsEvent","event:partnerId":this.pluginSettings.partner_id,"event:uiconfId":this.pluginSettings.kcw_ui_conf,"event:queryStringReferrer":window.location.href}}(0,a.default)(e,[{key:"queueAnalyticEvent",value:function(e){var t=d.default.clone(this.defaultData)
t["event:eventType"]=e
t["event:duration"]=this.mediaElement.duration
t["event:currentPoint"]=parseInt(1e3*this.mediaElement.currentTime)
t["event:eventTimestamp"]=(new Date).getTime()
return this.queueApiCall(this.apiUrl+o.default.param(t))}},{key:"ensureAnalyticSession",value:function(){this.kaSession=o.default.cookie("kaltura_analytic_tracker",void 0,{path:"/"})
if(!this.kaSession){this.kaSession=(Math.random().toString(16)+Math.random().toString(16)+Math.random().toString(16)).replace(/\./g,"")
return o.default.cookie("kaltura_analytic_tracker",this.kaSession,{path:"/"})}}},{key:"generateApiUrl",value:function(){var e=void 0
e="http:"===window.location.protocol?"http://"+this.pluginSettings.domain:"https://"+this.pluginSettings.domain
return this.apiUrl=e+"/api_v3/index.php?"}},{key:"setupApiIframes",value:function(e){this.qIndex=0
this.iframes=[]
for(var t=0,i=e-1,n=i>=0;n?t<=i:t>=i;n?t++:t--){var a=document.createElement("iframe");(0,o.default)(a).addClass("hidden kaltura-analytics");(0,o.default)(document.body).append((0,o.default)(a))
var r=[],s=function(e,t){return function(){var i
if(i=t.shift())return e.src=i}}(a,r)
this.iframes[t]={iframe:a,queue:r,pinger:d.default.throttle(s,4e3)}}return this.iframes}},{key:"queueApiCall",value:function(e){this.iframes||this.setupApiIframes(this.pluginSettings.parallel_api_calls||3)
this.iframes[this.qIndex].queue.push(e)
this.iframes[this.qIndex].pinger()
this.qIndex=(this.qIndex+1)%this.iframes.length
return this.qIndex}},{key:"addListeners",value:function(){var e=this
this.queueAnalyticEvent(1)
this.mediaElement.addEventListener("play",function(){e.mediaElement.pauseObserved=!1
e.mediaElement.endedObserved=!1
if(e.mediaElement.endedOnce){e.queueAnalyticEvent(mediaId,16)
e.mediaElement.endedOnce=!1}return e.queueAnalyticEvent(3)})
this.mediaElement.addEventListener("canplay",function(){return e.queueAnalyticEvent(2)})
this.mediaElement.addEventListener("seeked",function(){if(!e.mediaElement.endedObserved)return e.queueAnalyticEvent(17)})
this.mediaElement.addEventListener("pause",function(){if(!e.mediaElement.pauseObserved)return e.mediaElement.pauseObserved=!0})
this.mediaElement.addEventListener("progress",function(){if(!e.mediaElement.endedOnce)return e.queueAnalyticEvent(12)})
var t=0,i=!1
return this.mediaElement.addEventListener("playing",function(n){if(!e.mediaElement.listeningToPlaying){setInterval(function(){if(!e.mediaElement.paused&&!isNaN(e.mediaElement.duration)&&e.mediaElement.duration){if(e.mediaElement.isFullScreen!==i){i?e.queueAnalyticEvent(15):e.queueAnalyticEvent(14)
i=e.mediaElement.isFullScreen}var n=[.25*e.mediaElement.duration,.5*e.mediaElement.duration,.75*e.mediaElement.duration,.98*e.mediaElement.duration],a=e.mediaElement.currentTime
if(!isNaN(a)&&a>0){for(var o=n.length-1;o>=0;){var d=n[o]
d>t&&d<=a&&(0===o?e.queueAnalyticEvent(4):1===o?e.queueAnalyticEvent(5):2===o?e.queueAnalyticEvent(6):3===o&&e.queueAnalyticEvent(7));--o}return t=a}}},50)
return e.mediaElement.listeningToPlaying=!0}},!1)}}])
return e}()
e.exports=t.default},KPRNYFd0CF:function(e,t,i){"use strict"
var n,a=i("mOY9BNujNR"),o=(n=a)&&n.__esModule?n:{default:n}
function d(e){var t=o.default.Event("keyclick");(0,o.default)(e.target).trigger(t)
t.isDefaultPrevented()&&e.preventDefault()
t.isPropagationStopped()&&e.stopPropagation()}function r(e){switch(e.which){case 13:return d(e)
case 32:return e.preventDefault()}}function s(e){switch(e.which){case 32:return d(e)}}o.default.fn.activate_keyclick=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null
this.on("keydown",e,r)
...
this.isFirefox=e.MediaFeatures.isFirefox}l.keyCodes=r
...
return(0,d.findKey)(s,function(t){return e._targetControl(t).length})||"player"}
...
switch(this.keyCode){case r.DOWN:e=Math.min(a+1,n.length-1)
n.slice(e).first().focus().click()
break
case r.UP:e=Math.max(a-1,0)
n.slice(e).first().focus().click()
break
case r.ENTER:"a"===i.target.tagName.toLowerCase()&&(0,o.default)(i.target)[0].click()}}
...
case r.ENTER:(0,o.default)(t.target)[0].click()
break
...
switch(this.keyCode){case r.LEFT:case r.DOWN:case r.G_REWIND:i=Math.max(t.currentTime-e.options.defaultSeekBackwardInterval(t),0)
t.setCurrentTime(i)
break
case r.RIGHT:case r.UP:case r.G_FORWARD:i=Math.min(t.currentTime+e.options.defaultSeekForwardInterval(t),t.duration)
t.setCurrentTime(i)
break
case r.PAGE_DOWN:i=Math.max(t.currentTime-e.options.defaultJumpBackwardInterval(t),0)
t.setCurrentTime(i)
break
case r.PAGE_UP:i=Math.min(t.currentTime+e.options.defaultJumpForwardInterval(t),t.duration)
t.setCurrentTime(i)
break
case r.SPACE:if(this.isFirefox)break
case r.ENTER:t.paused?t.play():t.pause()}}
...
switch(this.keyCode){case r.SPACE:if(this.isFirefox)break
case r.ENTER:e.setMuted(!e.media.muted)
break
case r.LEFT:i=Math.max(0,t.volume-.1)
t.setVolume(i)
break
case r.RIGHT:i=Math.min(t.volume+.1,1)
t.setVolume(i)
break
case r.PAGE_DOWN:i=Math.max(0,t.volume-.5)
t.setVolume(i)
break
case r.PAGE_UP:i=Math.min(t.volume+.5,1)
t.setVolume(i)}}
l.prototype.playerHandler=function(){var e=this.player,t=this.media,i=this.event,n=void 0,a=void 0
switch(this.keyCode){case r.LEFT:case r.G_REWIND:n=Math.max(t.currentTime-e.options.defaultSeekBackwardInterval(t),0)
t.setCurrentTime(n)
break
case r.RIGHT:case r.G_FORWARD:n=Math.min(t.currentTime+e.options.defaultSeekForwardInterval(t),t.duration)
t.setCurrentTime(n)
break
case r.PAGE_DOWN:n=Math.max(t.currentTime-e.options.defaultJumpBackwardInterval(t),0)
t.setCurrentTime(n)
break
case r.PAGE_UP:n=Math.min(t.currentTime+e.options.defaultJumpForwardInterval(t),t.duration)
t.setCurrentTime(n)
break
case r.F:(0,o.default)(i.target).find(".mejs-fullscreen-button > button")[0].click()
break
case r.UP:a=t.volume
t.setVolume(Math.min(a+.1,1))
break
case r.DOWN:a=t.volume
t.setVolume(Math.max(0,a-.1))
break
case r.M:e.setMuted(!e.media.muted)
break
case r.SPACE:if(this.isFirefox)break
case r.ENTER:t.paused?t.play():t.pause()}}
t.default=l
e.exports=t.default},OGUJHwbmJb:function(e,t,i){"use strict"
var n,a=u(i("uceVF1dIMW")),o=u(i("iBw8ZGM6v8")),d=u(i("yvh8ynczHv")),r=u(i("mOY9BNujNR")),s=u(i("eJBzaBDd6c"))
i("D2yEjZ1CP5")
i("Q4xR9Iqymk")
i("pmU8As9kkw")
i("kzdUuF07HD")
...
i("11DZr9oB9c")
i("oxTDiksfqi")
function u(e){return e&&e.__esModule?e:{default:e}}r.default.mediaComment=function(e,t,i){var n=(0,r.default)("<div/>");(0,r.default)("body").append(n.hide())
r.default.fn.mediaComment.apply(n,arguments)}
r.default.mediaComment.partnerData=function(e){var t={context_code:r.default.mediaComment.contextCode(),root_account_id:ENV.DOMAIN_ROOT_ACCOUNT_ID,context_source:ENV.CONTEXT_ACTION_SOURCE}
ENV.SIS_SOURCE_ID&&(t.sis_source_id=ENV.SIS_SOURCE_ID)
ENV.SIS_USER_ID&&(t.sis_user_id=ENV.SIS_USER_ID)
return JSON.stringify(t)}
r.default.mediaComment.contextCode=function(){return ENV.context_asset_string||"user_"+ENV.current_user_id}
function l(e){var t=r.default.mediaComment.contextCode(),i={2:"image",5:"audio"}[e.mediaType]||"video"
t&&r.default.ajaxJSON("/media_objects","POST",{id:e.entryId,type:i,context_code:t,title:e.title,user_entered_title:e.userTitle},function(e){d.default.publish("media_object_created",e)},r.default.noop)
d.default.publish("media_comment_created",{id:e.entryId,mediaType:i,title:e.userTitle})}var c={}
r.default.mediaComment.entryAdded=function(e,t,i,n){if(e&&!c[e]){c[e]=!0
l({mediaType:t,entryId:e,title:i,userTitle:n})}}
r.default.mediaComment.audio_delegate={readyHandler:function(){try{(0,r.default)("#audio_upload")[0].setMediaType("audio")}catch(e){r.default.mediaComment.upload_delegate.setupErrorHandler()}},selectHandler:function(){r.default.mediaComment.upload_delegate.selectHandler("audio")},singleUploadCompleteHandler:function(e){r.default.mediaComment.upload_delegate.singleUploadCompleteHandler("audio",e)},allUploadsCompleteHandler:function(){r.default.mediaComment.upload_delegate.allUploadsCompleteHandler("audio")},entriesAddedHandler:function(e){r.default.mediaComment.upload_delegate.entriesAddedHandler("audio",e)},progressHandler:function(e){r.default.mediaComment.upload_delegate.progressHandler("audio",e[0],e[1],e[2])},uploadErrorHandler:function(){r.default.mediaComment.upload_delegate.uploadErrorHandler("audio")}}
r.default.mediaComment.video_delegate={readyWatcher:null,expectReady:function(){r.default.mediaComment.video_delegate.readyWatcher||(r.default.mediaComment.video_delegate.readyWatcher=setTimeout(r.default.mediaComment.upload_delegate.setupErrorHandler,2e3))},readyHandler:function(){try{(0,r.default)("#video_upload")[0].setMediaType("video")}catch(e){r.default.mediaComment.upload_delegate.setupErrorHandler()}clearTimeout(r.default.mediaComment.video_delegate.readyWatcher)
r.default.mediaComment.video_delegate.readyWatcher=!0},selectHandler:function(){r.default.mediaComment.upload_delegate.selectHandler("video")},singleUploadCompleteHandler:function(e){r.default.mediaComment.upload_delegate.singleUploadCompleteHandler("video",e)},allUploadsCompleteHandler:function(){r.default.mediaComment.upload_delegate.allUploadsCompleteHandler("video")},entriesAddedHandler:function(e){r.default.mediaComment.upload_delegate.entriesAddedHandler("video",e)},progressHandler:function(e){r.default.mediaComment.upload_delegate.progressHandler("video",e[0],e[1],e[2])},uploadErrorHandler:function(){r.default.mediaComment.upload_delegate.uploadErrorHandler("video")}}
r.default.mediaComment.upload_delegate={currentType:"audio",submit:function(){var e=r.default.mediaComment.upload_delegate.currentType,t=(0,r.default)("#"+e+"_upload")[0].getFiles()
t.length>1&&(0,r.default)("#"+e+"_upload")[0].removeFiles(0,t.length-2)
if(0!=(t=(0,r.default)("#"+e+"_upload")[0].getFiles()).length){(0,r.default)("#media_upload_progress").css("visibility","visible").progressbar({value:1});(0,r.default)("#media_upload_submit").attr("disabled",!0).text(a.default.t("messages.submitting","Submitting Media File..."));(0,r.default)("#"+e+"_upload")[0].upload()}},selectHandler:function(e){r.default.mediaComment.upload_delegate.currentType=e
try{var t=(0,r.default)("#"+e+"_upload")[0].getFiles()}catch(e){r.default.mediaComment.upload_delegate.setupErrorHandler()
return}t.length>1&&(0,r.default)("#"+e+"_upload")[0].removeFiles(0,t.length-2)
var i=(0,r.default)("#"+e+"_upload")[0].getFiles()[0];(0,r.default)("#media_upload_settings .icon").attr("src","/images/file-"+e+".png");(0,r.default)("#media_upload_submit").show();(0,r.default)("#media_upload_submit").attr("disabled",!i);(0,r.default)("#media_upload_settings").css("visibility",i?"visible":"hidden");(0,r.default)("#media_upload_title").val(i.title);(0,r.default)("#media_upload_display_title").text(i.title);(0,r.default)("#media_upload_file_size").text(r.default.fileSize(i.bytesTotal));(0,r.default)("#media_upload_feedback_text").html("");(0,r.default)("#media_upload_feedback").css("visibility","hidden")
if(i.bytesTotal>INST.kalturaSettings.max_file_size_bytes){(0,r.default)("#media_upload_feedback_text").html(a.default.t("errors.file_too_large","*This file is too large.* The maximum size is %{size}MB.",{size:INST.kalturaSettings.max_file_size_bytes/1048576,wrapper:"<b>$1</b>"}));(0,r.default)("#media_upload_feedback").css("visibility","visible");(0,r.default)("#media_upload_submit").hide()}else(0,r.default)("#media_upload_submit").click()},singleUploadCompleteHandler:function(e,t){(0,r.default)("#media_upload_progress").progressbar("option","value",100)},allUploadsCompleteHandler:function(e){(0,r.default)("#media_upload_progress").progressbar("option","value",100);(0,r.default)("#"+e+"_upload")[0].addEntries()},entriesAddedHandler:function(e,t){(0,r.default)("#media_upload_progress").progressbar("option","value",100)
var i=t[0];(0,r.default)("#media_upload_submit").text(a.default.t("messages.submitted","Submitted Media File!"))
setTimeout(function(){(0,r.default)("#media_comment_dialog").dialog("close")},1500)
"audio"==e?i.entryType=5:"video"==e&&(i.entryType=1)
r.default.mediaComment.entryAdded(i.entryId,i.entryType,i.title)},progressHandler:function(e,t,i,n){var a=100*t/i;(0,r.default)("#media_upload_progress").progressbar("option","value",a)},uploadErrorHandler:function(e){var t=(0,r.default)("#"+e+"_upload")[0].getError();(0,r.default)("#media_upload_errors").text(a.default.t("errors.upload_failed","Upload failed with error:")+" "+t);(0,r.default)("#media_upload_progress").hide()},setupErrorHandler:function(){(0,r.default)("#media_upload_feedback_text").text(a.default.t("errors.media_comment_installation_broken","Media comment uploading has not been set up properly. Please contact your administrator."));(0,r.default)("#media_upload_feedback").css("visibility","visible");(0,r.default)("#audio_upload_holder").css("visibility","hidden");(0,r.default)("#video_upload_holder").css("visibility","hidden")}}
var _=!1,m=null
r.default.mediaComment.init=function(e,t){i.e(7).then(function(){var o=i("LeFjTU1mPL")
m=m||new Date
e=e||"any"
t=t||{}
var d=r.default.trim((0,r.default)("#identity .user_name").text()||"")
d&&(d=d+": "+(new Date).toString("ddd MMM d, yyyy"))
var s=t.defaultTitle||d||a.default.t("titles.media_contribution","Media Contribution"),u=function(){var i,d
if(INST.kalturaSettings.js_uploader){i=n.getKs()
d=n.getUid()}else{i=g.data("ks")
d=g.data("uid")||"ANONYMOUS"}(0,r.default)("#video_record_title,#audio_record_title").val(s)
g.dialog({title:a.default.t("titles.record_upload_media_comment","Record/Upload Media Comment"),width:560,height:475,modal:!0})
g.dialog("option","close",function(){(0,r.default)("#audio_record").before("<div id='audio_record'/>").remove();(0,r.default)("#video_record").before("<div id='video_record'/>").remove()
t&&t.close&&r.default.isFunction(t.close)&&t.close.call(g)});(0,r.default)("#audio_record").before("<div id='audio_record'/>").remove();(0,r.default)("#video_record").before("<div id='video_record'/>").remove()
if("video"==e){(0,r.default)("#video_record_option").click();(0,r.default)("#media_record_option_holder").hide();(0,r.default)("#audio_upload_holder").hide();(0,r.default)("#video_upload_holder").show()}else if("audio"==e){(0,r.default)("#audio_record_option").click();(0,r.default)("#media_record_option_holder").hide();(0,r.default)("#audio_upload_holder").show();(0,r.default)("#video_upload_holder").hide()}else{(0,r.default)("#video_record_option").click();(0,r.default)("#audio_upload_holder").show();(0,r.default)("#video_upload_holder").show()}(0,r.default)(document).triggerHandler("reset_media_comment_forms")
var u=r.default.trim((0,r.default)("#identity .user_name").text())+" "+(new Date).toISOString()
setTimeout(function(){var e={host:location.protocol+"//"+INST.kalturaSettings.domain,rtmpHost:"rtmp://"+(INST.kalturaSettings.rtmp_domain||INST.kalturaSettings.domain),kshowId:"-1",pid:INST.kalturaSettings.partner_id,subpid:INST.kalturaSettings.subpartner_id,uid:d,ks:i,themeUrl:"/media_record/skin.swf",localeUrl:"/media_record/locale.xml",thumbOffset:"1",licenseType:"CC-0.1",showUi:"true",useCamera:"0",maxFileSize:INST.kalturaSettings.max_file_size_bytes/1048576,maxUploads:1,partnerData:r.default.mediaComment.partnerData(),partner_data:r.default.mediaComment.partnerData(),entryName:u,soundcodec:"Speex",autoPreview:"0"},t={align:"middle",quality:"high",bgcolor:"#ffffff",name:"KRecordAudio",allowScriptAccess:"sameDomain",type:"application/x-shockwave-flash",pluginspage:"http://www.adobe.com/go/getflashplayer",wmode:"opaque"};(0,r.default)("#audio_record").text(a.default.t("messages.flash_required_record_audio","Flash required for recording audio."))
o.embedSWF("/media_record/KRecord.swf","audio_record","400","300","9.0.0",!1,e,t)
t=r.default.extend({},t,{name:"KRecordVideo"}),e=r.default.extend({},e,{useCamera:"1"});(0,r.default)("#video_record").html("Flash required for recording video.")
o.embedSWF("/media_record/KRecord.swf","video_record","400","300","9.0.0",!1,e,t)},INST.browser.ie?500:10)
var l={host:location.protocol+"//"+INST.kalturaSettings.domain,partnerId:INST.kalturaSettings.partner_id,subPId:INST.kalturaSettings.subpartner_id,uid:d,entryId:"-1",ks:i,thumbOffset:"1",licenseType:"CC-0.1",maxFileSize:INST.kalturaSettings.max_file_size_bytes/1048576,maxUploads:1,partnerData:r.default.mediaComment.partnerData(),partner_data:r.default.mediaComment.partnerData(),uiConfId:INST.kalturaSettings.upload_ui_conf,jsDelegate:"$.mediaComment.audio_delegate"},c={align:"middle",quality:"high",bgcolor:"#ffffff",name:"KUpload",allowScriptAccess:"always",type:"application/x-shockwave-flash",pluginspage:"http://www.adobe.com/go/getflashplayer",wmode:"transparent"};(0,r.default)("#audio_upload").text(a.default.t("messages.flash_required_upload_audio","Flash required for uploading audio."))
var m="180",f="50"
...
l=r.default.extend({},l,{jsDelegate:"$.mediaComment.video_delegate"});(0,r.default)("#video_upload").text(a.default.t("messages.flash_required_upload_video","Flash required for uploading video."))
var h,p,v,y,k,b,w,x
m="180",f="50"
...
var C,M
_=!0
setInterval(function(){if(_){h=(0,r.default)("#audio_record_holder")
p=(0,r.default)("#audio_record")
v=(0,r.default)("#audio_record_meter")
y=0
k=0
b=(0,r.default)("#video_record_holder")
w=(0,r.default)("#video_record")
x=(0,r.default)("#video_record_meter")
C=0
M=0
_=!1}y++
C++
var e=null,t=null
p&&p[0]&&p[0].getMicophoneActivityLevel&&p.parent().length?e=p[0].getMicophoneActivityLevel():p=(0,r.default)("#audio_record")
w&&w[0]&&w[0].getMicophoneActivityLevel&&w.parent().length?t=w[0].getMicophoneActivityLevel():w=(0,r.default)("#video_record")
if(null!=e){if((e=Math.max(e,k))>-1&&!h.hasClass("with_volume")){v.css("display","none");(0,r.default)("#audio_record_holder").addClass("with_volume").animate({width:420},function(){v.css("display","")})}if(y>4){k=0
y=0
var i=(e-e%10)/10
v.attr("class","volume_meter band_"+i)}else k=e}if(null!=t){if((t=Math.max(t,M))>-1&&!b.hasClass("with_volume")){x.css("display","none");(0,r.default)("#video_record_holder").addClass("with_volume").animate({width:420},function(){x.css("display","")})}if(C>4){M=0
C=0
i=(t-t%10)/10
x.attr("class","volume_meter band_"+i)}else M=t}},20)}
if(INST.kalturaSettings.js_uploader){var c=i("Ft12a0AvJb");(n=new c(e,t)).onReady=u
n.addEntry=l
if(ENV.ARC_RECORDING_FEATURE_ENABLED){var f=i("muCowrVCN3").getBrowser();("Chrome"===f.name&&Number(f.version)>=68||"Firefox"===f.name&&Number(f.version)>=61)&&i.e(380).then(i.bind(null,"qFOglK6xBc")).then(function(e){var t=void 0
t=setInterval(function(){var i=document.getElementById("record_media_tab")
if(i){e(i,n.doUploadByFile)
clearInterval(t)}},10)})}}var h=new Date
h-m>3e5&&(0,r.default)("#media_comment_dialog").dialog("close").remove()
m=h
var g=(0,r.default)("#media_comment_dialog")
if(0!=g.length||INST.kalturaSettings.js_uploader)INST.kalturaSettings.js_uploader||u()
else{var p=(0,r.default)("<div/>").attr("id","media_comment_dialog")
...
r.default.ajaxJSON("/api/v1/services/kaltura_session","POST",{},function(e){p.data("ks",e.ks)
...
p.html(t())
p.find("#media_record_tabs").tabs({activate:r.default.mediaComment.video_delegate.expectReady})
u()}else p.data("ks-error")?p.html(p.data("ks-error")):setTimeout(e,500)}()
g=(0,r.default)("#media_comment_dialog")
g=p}}.bind(null,i)).catch(i.oe)};(0,r.default)(document).ready(function(){(0,r.default)(document).bind("reset_media_comment_forms",function(){(0,r.default)("#audio_record_holder_message,#video_record_holder_message").removeClass("saving").find(".recorder_message").html("Saving Recording...<img src='/images/media-saving.gif'/>");(0,r.default)("#audio_record_holder").stop(!0,!0).clearQueue().css("width","").removeClass("with_volume");(0,r.default)("#video_record_holder").stop(!0,!0).clearQueue().css("width","").removeClass("with_volume");(0,r.default)("#media_upload_submit").text(a.default.t("buttons.submit","Submit Media File")).attr("disabled",!0);(0,r.default)("#media_upload_settings").css("visibility","hidden");(0,r.default)("#media_upload_progress").css("visibility","hidden").progressbar().progressbar("option","value",1);(0,r.default)("#media_upload_title").val("")
var e=(0,r.default)("#audio_upload")[0]&&(0,r.default)("#audio_upload")[0].getFiles&&(0,r.default)("#audio_upload")[0].getFiles()
e&&(0,r.default)("#audio_upload")[0].removeFiles&&e.length>0&&(0,r.default)("#audio_upload")[0].removeFiles(0,e.length-1);(e=(0,r.default)("#video_upload")[0]&&(0,r.default)("#video_upload")[0].getFiles&&(0,r.default)("#video_upload")[0].getFiles())&&(0,r.default)("#video_upload")[0].removeFiles&&e.length>0&&(0,r.default)("#video_upload")[0].removeFiles(0,e.length-1)});(0,r.default)("#media_upload_submit").live("click",function(e){r.default.mediaComment.upload_delegate.submit()});(0,r.default)("#video_record_option,#audio_record_option").live("click",function(e){e.preventDefault();(0,r.default)("#video_record_option,#audio_record_option").removeClass("selected_option");(0,r.default)(this).addClass("selected_option");(0,r.default)("#audio_record_holder").stop(!0,!0).clearQueue().css("width","").removeClass("with_volume");(0,r.default)("#video_record_holder").stop(!0,!0).clearQueue().css("width","").removeClass("with_volume")
if("audio_record_option"==(0,r.default)(this).attr("id")){(0,r.default)("#video_record_holder_holder").hide();(0,r.default)("#audio_record_holder_holder").show()}else{(0,r.default)("#video_record_holder_holder").show();(0,r.default)("#audio_record_holder_holder").hide()}})});(0,r.default)(document).bind("media_recording_error",function(){(0,r.default)("#audio_record_holder_message,#video_record_holder_message").find(".recorder_message").html((0,s.default)(a.default.t("errors.save_failed","Saving appears to have failed.  Please close this popup to try again."))+"<div style='font-size: 0.8em; margin-top: 20px;'>"+(0,s.default)(a.default.t("errors.persistent_problem","If this problem keeps happening, you may want to try recording your media locally and then uploading the saved file instead."))+"</div>")})
window.mediaCommentCallback=function(e){o.default.each(e,l);(0,r.default)("#media_comment_create_dialog").empty().dialog("close")}
window.beforeAddEntry=function(){var e=Math.random()
r.default.mediaComment.lastAddAttemptId=e
setTimeout(function(){r.default.mediaComment.lastAddAttemptId==e&&(0,r.default)(document).triggerHandler("media_recording_error")},3e4);(0,r.default)("#audio_record_holder_message,#video_record_holder_message").addClass("saving")}
window.addEntryFail=function(){(0,r.default)(document).triggerHandler("media_recording_error")}
window.addEntryFailed=function(){(0,r.default)(document).triggerHandler("media_recording_error")}
window.addEntryComplete=function(e){r.default.mediaComment.lastAddAttemptId=null;(0,r.default)("#audio_record_holder_message,#video_record_holder_message").removeClass("saving")
try{var t=null
r.default.isArray(e)||(e=[e])
for(var i=0;i<e.length;i++){var n=e[i]
0==(0,r.default)("#media_record_tabs").tabs("option","selected")?t=(0,r.default)("#video_record_title,#audio_record_title").filter(":visible:first").val():(0,r.default)("#media_record_tabs").tabs("option","selected")
1==n.entryType&&(0,r.default)("#audio_record_option").hasClass("selected_option")&&(n.entryType=5)
r.default.mediaComment.entryAdded(n.entryId,n.entryType,n.entryName,t);(0,r.default)("#media_comment_dialog").dialog("close")}}catch(e){console.log(e)
...
o&&o.url&&o.seconds&&setTimeout(function(){a.default.ajaxJSON(o.url,"PUT",{interaction_seconds:o.seconds},function(){},function(){},3e3)})}catch(e){}document.cookie="last_page_view=; Path=/; expires=Thu, 01-Jan-1970 00:00:01 GMT"}if(t){var d,r=0;(0,a.default)(document).bind("page_view_update_url_received",function(e,i){t=i});(0,a.default)(document).bind("page_view_update",function(i,n){var o={}
if(n||e>10&&r<300){o.interaction_seconds=e
a.default.ajaxJSON(t,"PUT",o,null,function(e,t){422===t.status&&clearInterval(d)})
e=0}})
d=setInterval(function(){(0,a.default)(document).triggerHandler("page_view_update")},3e5)
...
s=!1
if(r>=300){r=0;(0,a.default)(document).triggerHandler("page_view_update")}r=0}else r++},1e3)}})},"QE/xL6drvs":function(e,t,i){"use strict"
var n,a=i("mOY9BNujNR"),o=(n=a)&&n.__esModule?n:{default:n}
if(ENV.ping_url)var d=setInterval(function(){document.hidden||o.default.post(ENV.ping_url).fail(function(e){401===e.status&&clearInterval(d)})},18e4)},QfIG3OPdTK:function(e,t,i){"use strict"
var n,a=i("mOY9BNujNR"),o=(n=a)&&n.__esModule?n:{default:n}
i("O9QjtziI9Q")
i("1YHB9uvbU1")
i("Nf4R7G01V5")
var d=i("i8I74pbaWm")
var r,s,u,l=(r={"left+":"right-","left-":"right+",left:"right","right+":"left-","right-":"left+",right:"left"},s=new RegExp(Object.keys(r).map(function(e){return e.replace(/[\-\+]/g,"\\$&")}).join("|")),u=function(e){return e.replace(s,function(e){return r[e]||e})},function(e,t){if((0,d.isRTL)(e)){t.my=u(t.my)
t.at=u(t.at)}}),c=0
function _(e,t){var i=(e.attr("aria-describedby")||"").split(/\s+/)
i.push(t)
e.data("ui-tooltip-id",t).attr("aria-describedby",o.default.trim(i.join(" ")))}function m(e){var t=e.data("ui-tooltip-id"),i=(e.attr("aria-describedby")||"").split(/\s+/),n=o.default.inArray(t,i);-1!==n&&i.splice(n,1)
e.removeData("ui-tooltip-id");(i=o.default.trim(i.join(" ")))?e.attr("aria-describedby",i):e.removeAttr("aria-describedby")}o.default.widget("ui.tooltip",{version:"@VERSION",options:{content:function(){return(0,o.default)(this).attr("title")},hide:!0,items:"[title]",position:{my:"left+15 center",at:"right center",collision:"flipfit flipfit"},show:!0,tooltipClass:null,track:!1,close:null,open:null},_create:function(){l(this.element[0],this.options.position)
...
this._on(this.document,{mousemove:d})
d(e)}else n.position(o.default.extend({of:t},this.options.position))
n.hide()
...
i.currentTarget=t[0]
this.close(i,!0)}}})}function d(e){a.of=e
...
var n,a=i("mOY9BNujNR"),o=(n=a)&&n.__esModule?n:{default:n}
i("VHZX6oywWS")
var d=o.default.ui.menu.prototype,r=d.refresh
o.default.extend(d,{refresh:function(){r.call(this)
...
var n=u(i("mOY9BNujNR")),a=u(i("iBw8ZGM6v8")),o=u(i("klGFYzYm7x")),d=u(i("cyMNwMhBvy")),r=u(i("ir8pL/Ro1S")),s=i("/rriEg1pXh")
i("XDPawBHrta")
i("Q4xR9Iqymk")
i("Q/pI8WL7wG")
i("FjPpBpSp8P")
...
i.e(16).then(function(e){i("il47VCngrj").open()}.bind(null,i)).catch(i.oe)});(0,n.default)("#skip_navigation_link").on("click",function(e){e.preventDefault();(0,n.default)((0,n.default)(this).attr("href")).attr("tabindex",-1).focus()})
var l=1200
function c(){var e=(0,n.default)("body").hasClass("course-menu-expanded")||(0,n.default)(document).width()>=l-15?0:-1;(0,n.default)("#section-tabs li a").attr("tabIndex",e)}(0,n.default)(c);(0,n.default)(window).on("resize",a.default.debounce(c,50));(0,n.default)("body").on("click","#courseMenuToggle",function(){(0,n.default)("body").toggleClass("course-menu-expanded");(0,d.default)();(0,n.default)("#left-side").css({display:(0,n.default)("body").hasClass("course-menu-expanded")?"block":"none"})
...
window.ENV.NEW_USER_TUTORIALS&&window.ENV.NEW_USER_TUTORIALS.is_enabled&&window.ENV.context_asset_string&&"courses"===(0,r.default)(window.ENV.context_asset_string)[0]&&i.e(10).then(function(e){i("72sEc2o3li")()}.bind(null,i)).catch(i.oe)
!(window.navigator.userAgent.indexOf("Edge")>-1)&&window.CSS&&window.CSS.supports&&window.CSS.supports("(--foo: red)")||i.e(18).then(function(e){window.canvasCssVariablesPolyfill=i("yLhLh4Z3xO")}.bind(null,i)).catch(i.oe);(0,n.default)(function(){(0,s.isMathMLOnPage)()&&(0,s.loadMathJax)("TeX-MML-AM_HTMLorMML")})},VHZX6oywWS:function(e,t,i){"use strict"
var n,a=i("mOY9BNujNR"),o=(n=a)&&n.__esModule?n:{default:n}
i("O9QjtziI9Q")
i("1YHB9uvbU1")
function d(){return[].some.call((0,o.default)(this).parents().andSelf(),function(e){return"none"==o.default.css(e,"display")})}var r=!1
...
this.focus(e,t)},mouseleave:"collapseAll","mouseleave .ui-menu":"collapseAll",focus:function(e){var t=this.active||this.element.children(".ui-menu-item").not(d).eq(0)
...
this.element.find(".ui-menu-divider").removeClass("ui-menu-divider ui-widget-content")},_keydown:function(e){var t,i,n,a,r,s=!0
...
n===i?a=!0:n=i+n
r=new RegExp("^"+u(n),"i")
t=this.activeMenu.children(".ui-menu-item").filter(function(){return r.test((0,o.default)(this).children("a").not(d).text())})
if(!(t=a&&-1!==t.index(this.active.next())?this.active.nextAll(".ui-menu-item"):t).length){n=String.fromCharCode(e.keyCode)
r=new RegExp("^"+u(n),"i")
t=this.activeMenu.children(".ui-menu-item").filter(function(){return r.test((0,o.default)(this).children("a").not(d).text())})}if(t.length){this.focus(e,t)
...
this._trigger("focus",e,{item:t})},_scrollIntoView:function(e){var t,i,n,a,d,r
...
r=e.height()
n<0?this.activeMenu.scrollTop(a+n):n+r>d&&this.activeMenu.scrollTop(a+n-d+r)}},blur:function(e,t){t||clearTimeout(this.timer)
...
this.focus(e,t)}},expand:function(e){var t=this.active&&this.active.children(".ui-menu ").children(".ui-menu-item").not(d).first()
if(t&&t.length){this._open(t.parent())
this._delay(function(){this.focus(e,t)})}},next:function(e){this._move("next","first",e)},previous:function(e){this._move("prev","last",e)},isFirstItem:function(){return this.active&&!this.active.prevAll(".ui-menu-item").not(d).length},isLastItem:function(){return this.active&&!this.active.nextAll(".ui-menu-item").not(d).length},_move:function(e,t,i){var n
this.active&&(n="first"===e||"last"===e?this.active["first"===e?"prevAll":"nextAll"](".ui-menu-item").not(d).eq(-1):this.active[e+"All"](".ui-menu-item").not(d).eq(0))
n&&n.length&&this.active||(n=this.activeMenu.children(".ui-menu-item").not(d)[t]())
...
this.active.nextAll(".ui-menu-item").not(d).each(function(){return(t=(0,o.default)(this)).offset().top-i-n<0})
this.focus(e,t)}else this.focus(e,this.activeMenu.children(".ui-menu-item").not(d)[this.active?"last":"first"]())}else this.next(e)},previousPage:function(e){var t,i,n
if(this.active){if(!this.isFirstItem())if(this._hasScroll()){i=this.active.offset().top
n=this.element.height()
this.active.prevAll(".ui-menu-item").not(d).each(function(){return(t=(0,o.default)(this)).offset().top-i+n>0})
this.focus(e,t)}else this.focus(e,this.activeMenu.children(".ui-menu-item").not(d).first())}else this.next(e)},_hasScroll:function(){return this.element.outerHeight()<this.element.prop("scrollHeight")},select:function(e){var t={item:this.active||(0,o.default)(e.target).closest(".ui-menu-item")}
t.item.has(".ui-menu").length||this.collapseAll(e,!0)
this._trigger("select",e,t)}})},WskX5tno7F:function(e,t,i){"use strict"
var n=r(i("whMk0QU2To")),a=r(i("+fL4qvKaPd")),o=r(i("mOY9BNujNR")),d=r(i("eJBzaBDd6c"))
i("Q4xR9Iqymk")
i("yR513+6+ip")
i("K/mYXqZAKq")
function r(e){return e&&e.__esModule?e:{default:e}}n.default.errorCount=0
window.onerror=function(e,t,i,a,o){n.default.errorCount+=1};(0,o.default)(document).ready(function(){(0,o.default)("#instructure_ajax_error_result").defaultAjaxError(function(e,t,i,r,s){if("abort"!==r){var u="0",l=a.default.t("no_text","No text")
try{u=t.status
l=t.responseText}catch(e){}o.default.ajaxJSON(location.protocol+"//"+location.host+"/simple_response.json?rnd="+Math.round(9999999*Math.random()),"GET",{},function(){if(o.default.ajaxJSON.isUnauthenticated(t)){var e=(0,d.default)(a.default.t("errors.logged_out","You are not currently logged in, possibly due to a long period of inactivity."))
e+="<br/><a href='/login' id='inactivity_login_link' target='_new'>"+(0,d.default)(a.default.t("links.login","Login"))+"</a>"
...
if(i){var r=i.contentDocument||i.contentWindow&&i.contentWindow.document||window.frames[c.attr("id")].document,_=(0,o.default)(r).find("body")
_.html((0,o.default)("<h1 />").text(a.default.t("error_heading","Ajax Error: %{status_code}",{status_code:u})))
_.append((0,d.default)(l));(0,o.default)("#instructure_ajax_error_box").hide()
e=(0,d.default)(e)
s&&(e+="<br/><span style='font-size: 0.7em;'>(Development Only)</span>");(s||"production"!=n.default.environment)&&(e+="<br/><a href='#' class='last_error_details_link'>"+(0,d.default)(a.default.t("links.details","details..."))+"</a>")
...
try{h=(0,o.default)("#identity .user_name").text()}catch(e){}if(n.default.ajaxErrorURL){var g="&Msg="+escape(l)+"&StatusCode="+escape(u)+"&URL="+escape(m.url||"unknown")+"&Page="+escape(location.href)+"&Method="+escape(m.submit_type||"unknown")+"&UserName="+escape(h)+"&Platform="+escape(navigator.platform)+"&UserAgent="+escape(navigator.userAgent)+"&Params="+escape(m.params||"unknown");(0,o.default)("body").append("<img style='position: absolute; left: -1000px; top: 0;' src='"+(0,d.default)(n.default.ajaxErrorURL+g.substring(0,2e3))+"' />")}}});(0,o.default)(".last_error_details_link").live("click",function(e){e.preventDefault()
e.stopPropagation();(0,o.default)("#instructure_ajax_error_box").show()});(0,o.default)(".close_instructure_ajax_error_box_link").click(function(e){e.preventDefault();(0,o.default)("#instructure_ajax_error_box").hide()})})},"a+Os3Kvywv":function(e,t,i){ENV.INCOMPLETE_REGISTRATION&&i.e(15).then(function(){var e=[i("mOY9BNujNR"),i("0sxI/h3fdS"),i("mqFaHUZWhf")];(function(e,t,i){return e(i({email:ENV.USER_EMAIL})).appendTo(e("body")).dialog({title:t.t("welcome_to_canvas","Welcome to Canvas!"),width:400,resizable:!1,buttons:[{text:t.t("get_started","Get Started"),click:function(){return e(this).dialog("close")},class:"btn-primary"}]})}).apply(null,e)}).catch(i.oe)},cyMNwMhBvy:function(e,t,i){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
...
if(!this.element.attr("id")){this.element.attr("id","ui-popup-"+d++)
...
i("QfIG3OPdTK")
function o(e){return e&&e.__esModule?e:{default:e}}var d={},r=function(e){return d[e]||d[e[0]]},s={setPosition:function(e){function t(){return(e.tooltipClass||"").match("popover")?30:5}var i="true"===e.force_position?"none":"flipfit",n={right:{my:"left center",at:"right+"+t()+" center",collision:i},left:{my:"right center",at:"left-"+t()+" center",collision:i},top:{my:"center bottom",at:"center top-"+t(),collision:i},bottom:{my:"center top",at:"center bottom+"+t(),collision:i}}
...
i.position.using||(i.position.using=u)
...
t.removeAttr("data-tooltip").timeoutTooltip(i).timeoutTooltip("open").click(function(){return t.timeoutTooltip("close")})});(0,n.default)(window).bind("detachTooltip",function(e){return d[e.target]=!0});(0,n.default)(window).bind("reattachTooltip",function(e){return d[e.target]=!1})
t.default=s
...
i("kWQsjZQaF4")
i("nwUwKBv/gu")
function d(e){return e&&e.__esModule?e:{default:e}}var r=function(){function e(t,i){var a=this;(0,n.default)(this,e);["onOpen","select","onClose","close","keepButtonActive"].forEach(function(e){return a[e]=a[e].bind(a)})
...
var d=this.$menu.data("popup"),r=d.open,s=this
d.open=function(){s.$menu.appendTo(s.opts.appendMenuTo)
...
var t=this.$trigger.outerWidth(),i=this.$trigger.offset().left,n=this.$menu[0].getBoundingClientRect(),a=this.$trigger[0].getBoundingClientRect(),d=n.top+n.height<a.top,r=n.height-2,s=e.pageX||i+t/2,u=i-this.$menu.offset().left,l=s-this.$trigger.offset().left,c=Math.min(Math.max(6,l),t-6)+u
this.$carat=(0,o.default)('<span class="ui-menu-carat"><span /></span>').css("left",c)
d&&this.$carat.css("top",r).css("transform","rotateX(180deg)")
this.$carat.prependTo(this.$menu)}}])
return e}()
r.defaults={popupOpts:{position:{my:"center top",at:"center bottom",offset:"0 10px",within:"#main",collision:"flipfit"}},buttonOpts:{addDropArrow:!0}}
t.default=r
o.default.fn.kyleMenu=function(e){return this.each(function(){(0,o.default)(this).data().kyleMenu||new r(this,e)})}
e.exports=t.default},zr2HOwddfD:function(e,t,i){"use strict"
var n=o(i("mOY9BNujNR")),a=o(i("eJBzaBDd6c"))
function o(e){return e&&e.__esModule?e:{default:e}}function d(e){e.data("handled",!0)
var t=e.data("url")||e.attr("href"),i=e.data("method"),o=e.attr("target"),d=(0,n.default)('<form method="post" action="'+(0,a.default)(t)+'"></form>'),r='\n    <input name="_method" value="'+(0,a.default)(i)+'" type="hidden" />\n    <input name="authenticity_token" type="hidden" />\n  '
o&&d.attr("target",o)
d.hide().append(r).appendTo("body").submit()}(0,n.default)(document).delegate("a[data-confirm], a[data-method], a[data-remove]","click",function(e){var t,i,a=(0,n.default)(this)
if(a.data("handled")||!(t=a,i=t.data("confirm"),!i||confirm(i)))return!1
if(a.data("remove")){r(a)
return!1}if(a.data("method")){d(a)
return!1}})
function r(e){var t=e.data("remove"),i=e,a=e.data("url"),o=e.closest(":ui-popup").popup("option","trigger").data("KyleMenu")
o&&o.opts.appendMenuTo&&(i=o.$placeholder)
var d=i.closest(t)
d.bind({beforeremove:function(){d.hide()},remove:function(){d.remove()}})
d.trigger("beforeremove")
var r=function(){return d.trigger("remove")}
a?n.default.ajaxJSON(a,"DELETE",{},r,function(){return d.show()}):r()}}},["VDPlEqaRwD"])

//# sourceMappingURL=common.bundle-02869e692d.js.91-02869e692d.sourcemap